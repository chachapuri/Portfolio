...
| 4. | [История конференций TED. Проект на DataLens]() | Анализ популярных тем, среднего количества выступающих, средней длины выступления, наиболее популярной области| Yandex DataLens|
